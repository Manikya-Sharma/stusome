  ...
  return loading ? (
    ...
    <div className="p-4 font-fancy dark:bg-slate-900 dark:text-slate-100 scroll-smooth">
      ...
      <div className="relative">
        <ul
          className={
            "md:sticky md:top-10 md:mr-2 md:left-2 md:inline-flex md:flex-col md:justify-start md:w-[15vw] w-[50vw] md:p-0 fixed z-[100] px-3 py-2 rounded-md left-0 top-10 transition-transform duration-200 bg-slate-800 text-slate-200 md:bg-transparent md:text-inherit h-[100vh] md:h-fit md:pr-2 max-h-[70vh] overflow-y-auto" +
            (openMenu
              ? " translate-x-0"
