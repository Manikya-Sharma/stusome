  ...
  return (
    <div>
      <textarea
        ...
        className="border border-slate-300 px-3 py-2 rounded-md mx-auto block w-fit mb-3 sm:w-[70%]"
        ref={mk_ref}
        onChange={() => setText(mk_ref.current?.value)}
      ></textarea>
      <div>
        <h3 className="text-center text-2xl">Preview</h3>
        <p className="markdown-wrapper w-[280.8px] h-[240px] sm:w-[70%] max-w-full px-3 py-2 text-slate-800 mx-auto border border-slate-300">
        ...
        <button
          ...
          onClick={() => props.uploadMarkdown(text)}
        >
          Post
        </button>
      </div>
